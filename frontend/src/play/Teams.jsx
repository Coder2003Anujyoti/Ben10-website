...
<div className="w-full  flex flex-wrap gap-x-6 gap-y-4 items-center justify-center py-10 flex-row">
  {teams.map((i)=>{
  return(
  <div className="text-center w-30 bg-green-500 rounded-full" onClick={()=>go(i)}>
...
{value!='' && <>
  <div className="flex p-4 flex-col justify-center items-center text-center border-t border-green-700 gap-4">
     {value===team && <h1 className="text-lg text-gray-900 font-bold">Your Team</h1>}
         {value!==team && <h1 className="text-lg text-gray-900 font-bold">Opposition Team</h1>} 
       <img src={`teams/${value}.webp`} className="w-24 h-24" />
     </div>
